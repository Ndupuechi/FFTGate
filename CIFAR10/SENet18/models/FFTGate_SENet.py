...
class BasicBlock(nn.Module):
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.activation = FFTGate(gamma1=1.5, phi=0.1, history_len=15)
...
class FFTGate_SENet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):   # Cifar10
...
# def PReLU_SENet18():
#     return PReLU_SENet(PreActBlock, [2,2,2,2])
