...
class FFTGate_VGG(nn.Module):
    def __init__(self, vgg_name):
        ...
        self.classifier = nn.Linear(512, 10)  # Final classification layer | 10: Cifar10 and 100: Cifar100
        ...
        for x in cfg:
            if x == 'M':
                ...
                layers += [
                    ...
                    nn.BatchNorm2d(x),
                    FFTGate(gamma1=1.5, phi=0.1, history_len=16, decay_mode="linear")  # decay_mode: "exp" or "linear"
